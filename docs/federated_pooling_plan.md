...
The figure exports are for visual QC and site-specific review. The underlying aggregate values for DLNM curves and ICU-hour trajectories are also exported as CSVs and should be used for pooled analyses.
