...
Ten sites contributed DLNM, descriptive, clinical trajectory, and model outputs: Emory, JHU, Michigan, NU, OHSU, Penn, RUMC, UCMC, UCSF, and UMN. DLNM estimates were available from all 10 sites. Coefficient-based heat outcome model exports were also available from all 10 sites, although the number of estimable sites varied by outcome because some site-specific confidence intervals were nonfinite for selected models.

### Primary MRT-Referenced Heat-OHCA Association

The primary MRT-referenced DLNM showed a positive association between high Tmax and OHCA. At 30.0 C, the pooled cumulative RR was 1.01 (95% CI, 0.96-1.06). At 32.5 C, the RR increased to 1.35 (95% CI, 1.06-1.72; p=0.016), and at 35.0 C the RR was 1.85 (95% CI, 1.33-2.59; p<0.001). Heterogeneity was low to modest across the MRT-referenced curve, with I2=21.1% at 32.5 C and I2=9.4% at 35.0 C.

The pooled site-level MRT-referenced hot-temperature contrast was RR 1.51 (95% CI, 1.24-1.83; p<0.001; I2=0%). Female patients had a numerically larger heat association than male patients in stratified models, but confidence intervals overlapped. Associations were also numerically larger among patients aged 65 years or older than among younger patients, though imprecision limited inference.

In sensitivity analyses using median temperature as the reference, the overall heat association was attenuated and not statistically clear (RR 1.15; 95% CI, 0.91-1.46; p=0.244; I2=41.5%). Additional humidity-plus-pollution adjustment produced a similar median-reference estimate (RR 1.15; 95% CI, 0.91-1.45).

### HROHCA Versus Non-HROHCA Clinical Outcomes

Using the heat95 clinical phenotype definition, 270 of 5,266 OHCA hospitalizations were classified as HROHCA and 4,996 as non-HROHCA. Hospital mortality was similar in HROHCA and non-HROHCA (53.7% vs 54.0%), as was death or hospice discharge (58.1% vs 57.8%). IMV use was also similar (89.6% vs 88.5%), and vasopressor use was slightly higher among HROHCA patients (82.2% vs 81.0%).

Adjusted coefficient-based models did not show clear differences in adverse outcomes for heat95 exposure. The pooled odds ratio for death or hospice was 0.99 (95% CI, 0.69-1.41; p=0.937), and the pooled odds ratio for hospital death was 1.00 (95% CI, 0.74-1.34; p=0.977). Heat95 exposure was not clearly associated with IMV (OR 1.43; 95% CI, 0.77-2.68) or vasopressor use (OR 1.13; 95% CI, 0.76-1.67). Continuous outcome models also showed no clear difference in ICU length of stay (geometric mean ratio [GMR] 1.02; 95% CI, 0.85-1.23) or IMV duration (GMR 0.96; 95% CI, 0.79-1.17).

### Early ICU Support Trajectories

Hourly support trajectories suggested that HROHCA patients were less likely to be receiving IMV during the early ICU period. At ICU hour 6, IMV prevalence was 34.4% in HROHCA versus 40.8% in non-HROHCA (difference, -6.4 percentage points; p=0.042). At hour 12, IMV prevalence was 31.1% versus 41.8% (difference, -10.7 percentage points; p=0.001). By hour 24 and later, IMV differences were smaller and less precise.

In contrast, vasopressor infusion prevalence was higher among HROHCA patients by hour 48 (35.3% vs 28.0%; difference, +7.4 percentage points; p=0.040). CRRT prevalence was numerically higher among HROHCA patients at later hours but did not meet conventional statistical thresholds. For example, at hour 48, CRRT prevalence was 11.4% versus 7.9% (difference, +3.5 percentage points; p=0.105).

### Renal and Metabolic Trajectories

Windowed renal/metabolic marker summaries showed broadly similar profiles between HROHCA and non-HROHCA. In the first 24 hours, peak lactate was higher in HROHCA (5.54 vs 4.60), but the approximate site-level p value was not significant. In the 24-72 hour window, lowest bicarbonate was slightly lower among HROHCA patients (21.25 vs 21.67; approximate p=0.299). Peak creatinine, BUN, potassium, magnesium, and phosphate were otherwise similar across groups.

CRRT use over prespecified windows was numerically higher among HROHCA patients but not statistically distinct: 8.2% versus 7.8% at 0-24 hours (p=0.804), 12.3% versus 10.4% at 0-72 hours (p=0.309), and 12.7% versus 11.4% at 0-168 hours (p=0.503).
...
In secondary pollution models, 12-month NO2 exposure per site-specific IQR was associated with death or hospice discharge in single-pollutant models (OR 1.04; 95% CI, 1.00-1.07; p=0.028). PM2.5 was not clearly associated with death or hospice discharge (OR 1.11; 95% CI, 0.89-1.40). Two-pollutant models attenuated these associations. Pollution-related continuous outcome models did not show clear associations with ICU length of stay or IMV duration.
