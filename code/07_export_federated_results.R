...
exports <- list(
  ...
  list(file.path(descriptive_dir, "ohca_ed_only_death_never_icu_timing_summary.csv"), "ohca_ed_only_death_never_icu_timing_summary"),
  list(file.path(descriptive_dir, "ohca_ed_only_death_never_icu_los_distribution.csv"), "ohca_ed_only_death_never_icu_los_distribution"),
  list(file.path(descriptive_dir, "ohca_ed_only_never_icu_discharge_category_audit.csv"), "ohca_ed_only_never_icu_discharge_category_audit"),
  list(file.path(descriptive_dir, "ohca_ed_only_death_never_icu_poa_audit.csv"), "ohca_ed_only_death_never_icu_poa_audit"),
  list(file.path(descriptive_dir, "ohca_diagnosis_code_audit.csv"), "ohca_diagnosis_code_audit"),
  ...
  list(file.path(manuscript_dir, "manuscript_dlnm_contrast_summaries.csv"), "dlnm_contrast_summaries"),
  ...
  list(file.path(manuscript_dir, "manuscript_dlnm_time_adjustment_contrast_summaries.csv"), "dlnm_time_sensitivity_contrast_summaries"),
  ...
  list(file.path(lag_diag_dir, "rate_lag30_diagnostic_summary.csv"), "rate_lag30_diagnostic_summary"),
  list(file.path(lag_diag_dir, "rate_lag30_temperature_lag_rr_surface.csv"), "rate_lag30_temperature_lag_rr_surface"),
  list(file.path(lag_diag_dir, "rate_lag30_hot_temperature_lag_specific_rr.csv"), "rate_lag30_hot_temperature_lag_specific_rr"),
  list(file.path(lag_diag_dir, "rate_lag30_hot_temperature_cumulative_rr_by_lag.csv"), "rate_lag30_hot_temperature_cumulative_rr_by_lag"),
  list(file.path(lag_diag_dir, "rate_lag30_temperature_distribution_source.csv"), "rate_lag30_temperature_distribution"),
  ...
  list(file.path(rate_dir, "ohca_icu_admission_rate_dlnm_contrast_summaries.csv"), "ohca_icu_admission_rate_dlnm_contrast_summaries"),
  ...
  list(file.path(case_crossover_dir, "case_crossover_dlnm_contrast_summaries.csv"), "case_crossover_dlnm_contrast_summaries"),
  ...
  list(file.path(case_crossover_dir, "case_crossover_lag0_results.csv"), "case_crossover_lag0_site_estimates"),
  list(file.path(case_crossover_dir, "case_crossover_lag0_curves.csv"), "case_crossover_lag0_curves"),
  list(file.path(case_crossover_dir, "case_crossover_lag0_contrast_summaries.csv"), "case_crossover_lag0_contrast_summaries"),
  list(file.path(case_crossover_dir, "case_crossover_lag0_coefficients.csv"), "case_crossover_lag0_coefficients"),
  list(file.path(case_crossover_dir, "case_crossover_lag0_vcov.csv"), "case_crossover_lag0_vcov"),
  list(file.path(case_crossover_dir, "case_crossover_referent_set_summary.csv"), "case_crossover_referent_set_summary"),
  list(file.path(case_crossover_dir, "case_crossover_lag30_diagnostic_summary.csv"), "case_crossover_lag30_diagnostic_summary"),
  list(file.path(case_crossover_dir, "case_crossover_lag30_hot_temperature_lag_specific_rr.csv"), "case_crossover_lag30_hot_temperature_lag_specific_rr"),
  list(file.path(case_crossover_dir, "case_crossover_lag30_hot_temperature_cumulative_rr_by_lag.csv"), "case_crossover_lag30_hot_temperature_cumulative_rr_by_lag"),
  ...
  list(file.path(phenotype_dir, "ohca_icu_72h_admission_temperature_distribution_summary.csv"), "ohca_icu_72h_admission_temperature_distribution_summary"),
  list(file.path(phenotype_dir, "ohca_icu_72h_admission_temperature_density.csv"), "ohca_icu_72h_admission_temperature_density"),
...
figure_paths <- file.path(figure_dir, c(
  ...
  "figure_rate_lag30_temperature_distribution.png",
  "figure_rate_lag30_temperature_lag_rr_surface.png",
  "figure_rate_lag30_hot_temperature_lag_specific_rr.png",
  "figure_rate_lag30_hot_temperature_cumulative_rr_by_lag.png",
  "figure_ohca_icu_admission_rate_temperature_timeseries.png",
  "figure_ohca_icu_admission_temperature_density.png",
