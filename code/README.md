...
6. `05_heat_related_vs_non_heat_related_table.R`: creates heat-related vs non-heat-related OHCA comparison tables, 90th-percentile sensitivity tables, ICU-hour clinical trajectories, cumulative incidence plots, CRRT summaries, and renal/metabolic phenotype summaries.
